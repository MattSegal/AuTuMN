...
def set_isolation_props(model, model_parameters, abs_props, stratification_adjustments):
    """
    ...
    return model, stratification_adjustments
...
def stratify_by_clinical(model, model_parameters, compartments):
    ...
    model, stratification_adjustments = set_isolation_props(
        model, model_parameters, abs_props, stratification_adjustments
    )
